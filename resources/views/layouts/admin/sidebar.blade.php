<aside class="w-64 border-r border-zinc-800/80 bg-zinc-900/60 p-4 flex flex-col justify-between hidden md:flex shrink-0">
    <div class="space-y-6">
        ...
        <nav class="space-y-1 text-sm font-medium text-zinc-400">
            <a href="/admin" class="flex items-center gap-3 px-3 py-2 rounded-lg text-white bg-zinc-800/80 font-medium">
                <svg class="w-4 h-4 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>
                Dashboard
            </a>
            <a href="/admin/users" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:text-white hover:bg-zinc-800/40 transition-all">
            ...
            <a href="/admin/packages" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:text-white hover:bg-zinc-800/40 transition-all">
            ...
            <a href="/admin/logs" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:text-white hover:bg-zinc-800/40 transition-all">
    ...
    <!-- Admin Status -->
    <div class="p-3 rounded-xl bg-zinc-950/60 border border-zinc-800/80 space-y-1 text-xs">
        ...
        <div class="flex items-center justify-between text-white font-medium">
            ...
            <span class="px-1.5 py-0.5 rounded bg-red-500/20 text-red-400 text-[10px] uppercase font-bold">Admin</span>
        </div>
    </div>
</aside>
