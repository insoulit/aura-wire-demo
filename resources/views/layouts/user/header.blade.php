        ...
        <div class="flex items-center gap-8">
            <a href="{{ route('home') }}" class="flex items-center gap-3 group">
                ...
                <div>
                    ...
                    <p class="text-xs text-zinc-400">User Workspace</p>
                </div>
            </a>

            <nav class="hidden md:flex items-center gap-1 text-sm font-medium text-zinc-400">
                <a href="/dashboard" class="px-3 py-1.5 rounded-lg text-white bg-zinc-800/80 font-medium">Dashboard</a>
                <a href="/projects" class="px-3 py-1.5 rounded-lg hover:text-white hover:bg-zinc-800/40 transition-all">Projects</a>
                <a href="/settings" class="px-3 py-1.5 rounded-lg hover:text-white hover:bg-zinc-800/40 transition-all">Settings</a>
            </nav>
        </div>

        <div class="flex items-center gap-4">
            <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium bg-zinc-800 text-zinc-300 border border-zinc-700">
