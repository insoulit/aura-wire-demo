<x-aura::header>
    <x-slot name="brand">
        <a href="{{ route('home') }}" class="flex items-center gap-3 group">
            ...
            <div>
                <x-aura::heading level="1" size="xs" class="group-hover:text-blue-600 dark:group-hover:text-blue-400 font-extrabold tracking-tight">Aura Wire UI</x-aura::heading>
    ...
    <x-slot name="actions">
        <a href="https://packagist.org/packages/insoulit/aura-wire" target="_blank" rel="noopener noreferrer" class="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-zinc-700 dark:text-zinc-300 hover:text-blue-600 dark:hover:text-blue-400 bg-zinc-100/80 dark:bg-zinc-800/80 hover:bg-zinc-200 dark:hover:bg-zinc-800 rounded-xl border border-zinc-200/80 dark:border-zinc-700/60 transition-all">
            <svg class="w-4 h-4 text-blue-500" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>
            <span>Packagist</span>
        </a>
        <x-theme-switcher />
    </x-slot>
