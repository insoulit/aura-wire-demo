<x-aura::header>
    <x-slot name="brand">
        <a href="{{ route('home') }}" class="flex items-center gap-3 group">
            ...
            <div>
                <x-aura::heading level="1" size="xs" class="group-hover:text-emerald-600 dark:group-hover:text-emerald-400 font-extrabold tracking-tight">Aura Wire UI</x-aura::heading>
