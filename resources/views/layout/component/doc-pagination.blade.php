...
@if ($prevPage || $nextPage)
    <div class="w-full max-w-4xl mx-auto pt-8 mt-12 border-t border-zinc-200 dark:border-zinc-800/80 grid grid-cols-2 gap-4">
        <div>
            @if ($prevPage)
                <a href="{{ $prevPage['url'] }}" wire:navigate class="group flex flex-col p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-zinc-400 dark:hover:border-zinc-600 bg-white dark:bg-zinc-900/50 transition-all shadow-2xs">
        ...
        <div class="text-right">
            @if ($nextPage)
                <a href="{{ $nextPage['url'] }}" wire:navigate class="group flex flex-col items-end p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-zinc-400 dark:hover:border-zinc-600 bg-white dark:bg-zinc-900/50 transition-all shadow-2xs">
                    <span class="text-[11px] font-semibold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider flex items-center gap-1.5 mb-1 group-hover:text-zinc-900 dark:group-hover:text-white transition-colors">
                        Next
