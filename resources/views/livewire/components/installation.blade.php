...
<div class="space-y-10 max-w-4xl">
        ...
        <div class="flex items-center justify-between gap-4">
            <div>
                ...
                <x-aura::subheading class="mt-2">
                    Install <code class="text-blue-600 dark:text-blue-400 font-mono">insoulit/aura-wire</code> via Composer into your Laravel application and publish assets.
                </x-aura::subheading>
            </div>

            <a href="https://packagist.org/packages/insoulit/aura-wire" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold text-white bg-blue-600 hover:bg-blue-500 transition-all group">
    ...
    <div class="space-y-6">
        ...
        <x-aura::card class="space-y-3">
            <div class="flex items-center gap-3">
                <span class="flex items-center justify-center w-7 h-7 rounded-lg bg-zinc-900 text-white dark:bg-white dark:text-zinc-900 font-bold text-xs">1</span>
        ...
        <x-aura::card class="space-y-3">
            <div class="flex items-center gap-3">
                <span class="flex items-center justify-center w-7 h-7 rounded-lg bg-zinc-900 text-white dark:bg-white dark:text-zinc-900 font-bold text-xs">2</span>
        ...
        <x-aura::card class="space-y-3">
            <div class="flex items-center gap-3">
                <span class="flex items-center justify-center w-7 h-7 rounded-lg bg-zinc-900 text-white dark:bg-white dark:text-zinc-900 font-bold text-xs">3</span>
                <x-aura::heading level="2" size="md">Register Component Views in Tailwind</x-aura::heading>
            </div>
            <x-aura::text size="sm" variant="subtle">Ensure your <code class="text-blue-600 dark:text-blue-400 font-mono">tailwind.config.js</code> or CSS includes vendor components:</x-aura::text>
    ...
    './vendor/insoulit/aura-wire/resources/views/**/*.blade.php',
        ...
        <x-aura::card class="space-y-3">
            <div class="flex items-center gap-3">
                <span class="flex items-center justify-center w-7 h-7 rounded-lg bg-zinc-900 text-white dark:bg-white dark:text-zinc-900 font-bold text-xs">4</span>
                <x-aura::heading level="2" size="md">Use Components with Shorthand Tag Syntax</x-aura::heading>
            </div>
            <x-aura::text size="sm" variant="subtle">You can now render components using either <code class="text-blue-600 dark:text-blue-400 font-mono">&lt;x-aura::button&gt;</code> or shorthand <code class="text-blue-600 dark:text-blue-400 font-mono">&lt;aura:button&gt;</code>:</x-aura::text>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                <div class="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 space-y-2">
                    <div class="text-xs font-semibold text-blue-600 dark:text-blue-400 uppercase tracking-wider">Shorthand Tag Syntax</div>
