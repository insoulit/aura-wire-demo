...
new class extends Component {
    ...
    {
        $view->layout('layouts.components')->title('Timeline - Aura Wire');
    }
};
...
<div class="w-full max-w-4xl mx-auto space-y-10 flex flex-col items-center justify-center">
    ...
    <x-aura::code class="w-full" title="1. Deployment & Release History">
        <x-slot:preview>
            <x-aura::timeline class="w-full">
                <x-aura::timeline.item title="v1.2.0 Released to Production" time="Just now" variant="solid" description="Deployed 11 new UI components to the insoulit/aura-wire suite." />
    ...
    &lt;x-aura::timeline.item title="v1.2.0 Released to Production" time="Just now" variant="solid" description="Deployed 11 new UI components." /&gt;
