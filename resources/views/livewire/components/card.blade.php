...
<div class="w-full space-y-10">
    ...
    <div class="p-6 rounded-2xl bg-white dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800/80 space-y-6 shadow-sm max-w-lg">
        ...
        <pre class="text-[11px] font-mono p-3 rounded-xl bg-zinc-100 dark:bg-zinc-950 text-zinc-800 dark:text-zinc-300"><code>&lt;x-aura::card title="Title" description="..."&gt;
    &lt;p&gt;Content&lt;/p&gt;
&lt;/x-aura::card&gt;</code></pre>
    </div>
</div>
