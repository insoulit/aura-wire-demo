...
<div class="w-full space-y-10">
    ...
    <div class="p-6 rounded-2xl bg-white dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800/80 space-y-4 max-w-sm">
        ...
        <pre class="text-[11px] font-mono p-3 rounded-xl bg-zinc-100 dark:bg-zinc-950 text-zinc-800 dark:text-zinc-300"><code>&lt;x-aura::label required&gt;Email Address&lt;/x-aura::label&gt;</code></pre>
    </div>
</div>
