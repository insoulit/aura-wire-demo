...
new #[Layout('layouts.components')] #[Title('Breadcrumbs - Aura Wire')] class extends Component {
...
&lt;!-- Slash Separator --&gt;
&lt;x-aura::breadcrumbs :items="..." separator="slash" /&gt;

&lt;!-- Dot Separator --&gt;
&lt;x-aura::breadcrumbs :items="..." separator="dot" /&gt;

&lt;!-- Arrow Separator --&gt;
&lt;x-aura::breadcrumbs :items="..." separator="arrow" /&gt;</x-slot:codeSlot>
    </x-aura::code>
        ...
        <x-slot:preview>
            <div class="space-y-6 w-full">
                <div class="space-y-2">
                    ...
                    <x-aura::breadcrumbs :items="$deepItems" variant="rectangle" :homeIcon="true" />
                </div>

                <div class="space-y-2">
                    <p class="text-xs font-bold text-zinc-500 uppercase tracking-wider">Circular Pill Badges (variant="pills"):</p>
                    <x-aura::breadcrumbs :items="$simpleItems" variant="pills" :homeIcon="true" />
                </div>
            </div>
        </x-slot:preview>
        <x-slot:codeSlot>&lt;!-- Rectangular Panel Box --&gt;
&lt;x-aura::breadcrumbs :items="$items" variant="rectangle" :homeIcon="true" /&gt;

&lt;!-- Circular Pill Badges --&gt;
&lt;x-aura::breadcrumbs :items="$items" variant="pills" :homeIcon="true" /&gt;</x-slot:codeSlot>
    </x-aura::code>
    ...
    <x-aura::code class="w-full" title="3. Deep Navigation Trail with Home Icon">
        <x-slot:preview>
            <div class="w-full">
                <x-aura::breadcrumbs :items="$deepItems" :homeIcon="true" separator="chevron" />
            </div>
        </x-slot:preview>
