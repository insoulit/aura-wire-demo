...
<x-aura::container gap="8" :padding="false">
    ...
    <x-aura::code title="1. Tag Variants">
        ...
        <x-slot:preview>
            ...
            <x-aura::flex align="center" gap="2.5" :wrap="true">
    ...
    <x-aura::card size="full" gap="4">
        ...
        <x-aura::flex direction="col" gap="1">
            ...
            <x-aura::text variant="subtle" size="sm">
                Available properties and configurations for the tag component.
            </x-aura::text>
            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Tag padding and text scale dimension" position="top">
