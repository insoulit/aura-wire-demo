            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Structural banner layout and background treatment style" position="top">
            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Primary alert headline title text" position="top">
            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Display close button and allow dismiss interaction" position="top">
            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Leading Lucide icon override" position="top">
            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Accent badge tag displayed before title" position="top">
