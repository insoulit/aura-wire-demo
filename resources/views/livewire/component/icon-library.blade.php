...
<x-aura::container gap="8" :padding="false">
    ...
    <!-- Search & Filter Bar -->
    <x-aura::card size="full">

        <x-aura::flex align="center" justify="between" gap="4" class="flex-col sm:flex-row w-full">

            <div class="w-full sm:w-96">
                <x-aura::input wire:model.live.debounce.150ms="search" placeholder="Search icons... (e.g. user, bell, chart, arrow)" icon="search" size="sm" />
            </div>
                ...
                @if ($this->totalPages > 1)
                    ...
                    <div class="pt-6 border-t border-zinc-200 dark:border-zinc-800/80 w-full">
                        ...
                        <x-aura::flex align="center" justify="between" gap="4" class="flex-col sm:flex-row w-full">
                            ...
                            <x-aura::text size="sm">
                                Showing {{ (($page - 1) * $perPage) + 1 }} to {{ min($page * $perPage, $this->totalFilteredCount) }} of {{ number_format($this->totalFilteredCount) }} icons
                            </x-aura::text>
