    ...
    <x-aura::code title="1. Field Wrapper">
        ...
        <x-slot:preview>
            ...
            <x-aura::card size="2xl" gap="4">
                ...
                <x-aura::field label="Username" hint="Enter a unique handle" :required="true">
                    <x-aura::input placeholder="johndoe" />
                </x-aura::field>
            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Associated field name for error lookup and for attribute binding" position="top">
            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Explicit error message string override" position="top">
