            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Primary input label text" position="top">
            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Checkbox dimensional scale and box sizing" position="top">
            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Initial checked status boolean" position="top">
            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Checkbox value when selected or submitted" position="top">
