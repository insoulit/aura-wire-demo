    ...
    <x-aura::card size="full" gap="4">
        ...
        <x-aura::flex direction="col" gap="1">
            ...
            <x-aura::text variant="subtle" size="sm">
                Available properties and configurations for the label component.
            </x-aura::text>
            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Display mandatory red asterisk indicator" position="top">
            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Label font size scale" position="top">
