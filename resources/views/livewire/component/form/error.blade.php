    ...
    <x-aura::card size="full" gap="4">
        ...
        <x-aura::flex direction="col" gap="1">
            ...
            <x-aura::text variant="subtle" size="sm">
                Available properties and configurations for the error message component.
            </x-aura::text>
            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Explicit error message string to display" position="top">
            ...
            <x-aura::table.row>
                ...
                <x-aura::table.cell>
                    ...
                    <x-aura::flex align="center" gap="1.5" :inline="true">
                        ...
                        <x-aura::tooltip text="Validation field name to look up inside Laravel errors bag" position="top">
