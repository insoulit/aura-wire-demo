        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
            <div class="space-y-3 max-w-2xl">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <x-aura::kicker>Package Component Library</x-aura::kicker>
                        <x-aura::heading level="2" size="lg">Aura Wire Components</x-aura::heading>
                    </div>
                </div>
                <x-aura::text variant="subtle" size="md">
