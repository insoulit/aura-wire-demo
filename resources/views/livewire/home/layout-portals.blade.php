        ...
        <div class="flex flex-col justify-between h-full group transition-all duration-300 hover:-translate-y-1">
            ...
            <x-aura::card>
                ...
                <x-slot:footer>
                    ...
                    <x-aura::button variant="primary" size="md" block="true" href="/guest" icon="arrow-right" iconPlacement="right">
                        Explore
                    </x-aura::button>
        ...
        <div class="flex flex-col justify-between h-full group transition-all duration-300 hover:-translate-y-1">
            ...
            <x-aura::card>
                ...
                <x-slot:footer>
                    ...
                    <x-aura::button variant="primary" size="md" block="true" href="/user" icon="arrow-right" iconPlacement="right">
                        Launch
                    </x-aura::button>
        ...
        <div class="flex flex-col justify-between h-full group transition-all duration-300 hover:-translate-y-1">
            ...
            <x-aura::card>
                ...
                <x-slot:footer>
                    ...
                    <x-aura::button variant="primary" size="md" block="true" href="/admin" icon="arrow-right" iconPlacement="right">
                        Access
                    </x-aura::button>
