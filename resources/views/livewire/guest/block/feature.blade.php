...
<div class="w-full max-w-4xl mx-auto space-y-4 py-6">
    ...
    <x-aura::code class="w-full" title="3-Column Feature Highlight Block">
        <x-slot:preview>
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 w-full">
                <!-- Feature 1: Enterprise Security -->
                <x-aura::card class="p-5 hover:border-zinc-400 dark:hover:border-zinc-600 transition-all group flex flex-col justify-between space-y-4">
                    <div class="space-y-3">
                        ...
                        <div class="space-y-1">
                            <x-aura::heading level="3" size="sm" class="group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                ...
                <x-aura::card class="p-5 hover:border-zinc-400 dark:hover:border-zinc-600 transition-all group flex flex-col justify-between space-y-4">
                    <div class="space-y-3">
                        ...
                        <div class="space-y-1">
                            <x-aura::heading level="3" size="sm" class="group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">
