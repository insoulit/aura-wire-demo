    ...
    <div class="relative space-y-10 max-w-5xl mx-auto">
        ...
        <div class="text-center space-y-6 max-w-4xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 pt-2 w-full sm:w-auto max-w-xs sm:max-w-none mx-auto">
                ...
                <x-aura::button variant="outline" size="lg" icon="play">
                    Demo
                </x-aura::button>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <x-aura::card>
                ...
                <div class="space-y-4">
                    ...
                    <div class="font-bold text-3xl text-zinc-900 dark:text-white">
                        {{ $annualBilling ? '$19' : '$25' }}
            ...
            <x-aura::card>
                ...
                <div class="space-y-4">
                    ...
                    <div class="font-bold text-4xl text-zinc-900 dark:text-white">
                        {{ $annualBilling ? '$79' : '$99' }}
                        <span class="text-xs font-normal text-zinc-500">/mo</span>
                    </div>
            ...
            <x-aura::card>
                ...
                <div class="pt-6">
                    ...
                    <x-aura::button variant="outline" size="md" icon="arrow-right" iconPlacement="right">
                        Contact
                    </x-aura::button>
