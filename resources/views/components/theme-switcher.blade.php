<div x-data="{
    ...
    <button @click="setTheme('light')" :class="theme === 'light' ? 'bg-white text-amber-500 shadow-sm' : 'hover:text-zinc-900 dark:hover:text-white'" class="p-1.5 rounded-md transition-all" title="Light Mode" type="button">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
    </button>
    <button @click="setTheme('dark')" :class="theme === 'dark' ? 'bg-zinc-800 text-indigo-400 shadow-sm' : 'hover:text-zinc-900 dark:hover:text-white'" class="p-1.5 rounded-md transition-all" title="Dark Mode" type="button">
