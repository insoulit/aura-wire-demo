...
it('returns a successful 200 response for all component and portal page links', function (string $url) {
    ...
    'Block Pricing' => '/guest/block/pricing',
    'Block Dashboard' => '/guest/block/dashboard',
    'Block Auth' => '/guest/block/auth',
    'Block Profile' => '/guest/block/profile',
    'Block Hero' => '/guest/block/hero',
    'Block Feature' => '/guest/block/feature',
    'Block CTA' => '/guest/block/cta',
    'Block Testimonial' => '/guest/block/testimonial',
    'Block Modal' => '/guest/block/modal',
    'Block Slide Over' => '/guest/block/slide-over',
    'Block Timeline' => '/guest/block/timeline',
    'Block Empty State' => '/guest/block/empty-state',
    'Block FAQ' => '/guest/block/faq',
    'Block Navigation' => '/guest/block/navigation',
]);
