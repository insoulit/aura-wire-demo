...
Volt::route('/guest/template/portfolio', 'guest.template.portfolio.index')->name('guest.template.portfolio');
Volt::route('/guest/template/restaurant', 'guest.template.restaurant.index')->name('guest.template.restaurant');
Volt::route('/guest/template/saas', 'guest.template.saas.index')->name('guest.template.saas');
Volt::route('/guest/template/agency', 'guest.template.agency.index')->name('guest.template.agency');

// Direct /guest/* Template Aliases
Volt::route('/guest/ecommerce', 'guest.template.ecommerce.index')->name('guest.ecommerce');
Volt::route('/guest/portfolio', 'guest.template.portfolio.index')->name('guest.portfolio');
Volt::route('/guest/restaurant', 'guest.template.restaurant.index')->name('guest.restaurant');
Volt::route('/guest/saas', 'guest.template.saas.index')->name('guest.saas');
Volt::route('/guest/agency', 'guest.template.agency.index')->name('guest.agency');
